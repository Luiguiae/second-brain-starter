...
Configuración de arranque (Dockerfile o Procfile + variables de entorno) y smoke test post-deploy.
...
- **Railway**: deploy; variables de entorno y comando de arranque a definir en Fase 9.
